  ...
  return (
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <section className={styles.hero}>
          <div className={styles.heroGrid}>
            <div className={styles.heroCopy}>
              <p className={styles.kicker}>A ForgeMeter product · Free & open source</p>
              <h1 className={styles.title}>
                Stop agent exfil after the{" "}
                <span className={styles.titleAccent}>session is tainted</span>
              </h1>
              <p className={styles.lede}>
                Your coding agent can read private data, then post it to Slack.
                ForgeFence sits in the middle and <em>blocks that second step</em> — even if
                the model was tricked.
              </p>
              ...
              <p className={styles.heroNote}>
                Self-hosted MCP proxy · Pair with{" "}
        ...
        <section className={`${styles.section} ${styles.band}`} id="video">
          ...
          <ol className={styles.storyboard}>
            ...
            <li>
              ...
              <div>
                ...
                <p>
                  <code>demo__read_private</code> returns a fake SSN / API key. Session is now
                  tainted.
                </p>
              </div>
            </li>
            <li>
              ...
              <div>
                ...
                <p>
                  <code>demo__post_public</code> returns <strong>ForgeFence DENY</strong> — the
                  fence closed.
                </p>
              </div>
            </li>
        ...
        <section className={styles.section} id="how">
          ...
          <ol className={styles.steps}>
            <li>
              <strong>Pin</strong>
              <span>
                Remember each tool’s description. If it silently changes (rug-pull), hide it.
              </span>
            </li>
            <li>
              <strong>Taint</strong>
            ...
            <li>
              <strong>Fence</strong>
              <span>
                Block email, HTTP, shell, Slack-style posts while that stamp is present.
              </span>
            </li>
          </ol>
        </section>

        <section className={`${styles.section} ${styles.band}`} id="demo">
          <div className={styles.sectionHead}>
    ...
    "forgefence": {
      ...
      "cwd": "C:/source/ForgeFence"
        ...
        <section className={`${styles.section} ${styles.band}`}>
          <div className={`${styles.sectionHead} ${styles.sectionNarrow}`}>
...
function FlowDiagram() {
  return (
    <svg className={styles.flowSvg} viewBox="0 0 720 220" role="img">
      ...
      <rect x="24" y="56" width="140" height="110" rx="12" className={styles.svgBox} />
      <rect x="230" y="48" width="200" height="126" rx="12" className={styles.svgBoxAccent} />
      <rect x="500" y="56" width="180" height="48" rx="10" className={styles.svgBox} />
      <rect x="500" y="118" width="180" height="48" rx="10" className={styles.svgBox} />
